...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/<BENUTZERNAME>/scripte/main/authentik/authentik-setup.sh)"
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/<BENUTZERNAME>/scripte/main/authentik/authentik-setup.sh)" 2025.8.1
```
